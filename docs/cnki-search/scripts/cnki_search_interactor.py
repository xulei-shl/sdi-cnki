...
class CnkiSearchInteractor(
    ...
    def _build_result_payload(
        ...
        report_file,
        progress_file,
        resumed_from_progress,
        status,
    ):
        payload = super()._build_result_payload(
        ...
        payload["synonym_extend"] = bool(search_params.get("synonym_extend"))
        date_range_val = search_params.get("date_range")
        if date_range_val:
            payload["date_range_type"] = self.DATE_RANGE_LABEL_MAP.get(date_range_val, date_range_val)
            payload["date_range"] = payload["date_range_type"]
        return payload
