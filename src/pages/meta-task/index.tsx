        ...
        {detailLoading ? (
          ...
          <>
            ...
            <DetailSection label="检索参数">
              <DetailRow label="检索词">{(() => { const sp = (selectedTask as any).search_params || {}; const qs = sp.queries?.length ? sp.queries : (sp.query ? [sp.query] : []); return qs.length ? qs.join(' / ') : '-'; })()}</DetailRow>
